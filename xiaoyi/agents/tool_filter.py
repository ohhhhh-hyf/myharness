...
def build_teammate_tools(
    ...
    from xiaoyi.tools.send_message import SendMessageTool
    from xiaoyi.tools.task_create import TaskCreateTool
    from xiaoyi.tools.task_get import TaskGetTool
    from xiaoyi.tools.task_list import TaskListTool
    from xiaoyi.tools.task_update import TaskUpdateTool

...
PROJECT_AGENTS_DIR = ".xiaoyi/agents"
USER_AGENTS_DIR = "~/.xiaoyi/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("xiaoyi.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from xiaoyi.agents.parser import parse_frontmatter, _validate_agent_meta

...
from xiaoyi.conversation import Attachment, ConversationManager, Message, ToolResultBlock, ToolUseBlock

SESSIONS_DIR = ".xiaoyi/sessions"
    ...
    def from_message(cls, message: Message) -> list[SessionRecord]:
        ...
        if message.tool_results:
            ...
            if message.attachments:
                ...
                records.append(
                    cls(type=RecordType.USER, content=blocks, timestamp=now)
                )
            else:
                records.append(

...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from xiaoyi.tools.edit_file import EditFile
    from xiaoyi.tools.file_state_cache import FileStateCache
    from xiaoyi.tools.glob import Glob
    from xiaoyi.tools.grep import Grep

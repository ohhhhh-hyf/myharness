...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from xiaoyi.agents.fork import ForkError, build_forked_messages
        ...
        if p.subagent_type is None:
            from xiaoyi.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from xiaoyi.agents.fork import ForkError, build_forked_messages
        from xiaoyi.agents.parser import AgentDef
        from xiaoyi.agents.tool_filter import build_teammate_tools
        from xiaoyi.agent import Agent as AgentClass
        from xiaoyi.conversation import ConversationManager
        from xiaoyi.permissions import (
            DangerousCommandDetector,
        ...
        from xiaoyi.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from xiaoyi.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from xiaoyi.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from xiaoyi.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from xiaoyi.client import create_client
        from xiaoyi.config import ProviderConfig
